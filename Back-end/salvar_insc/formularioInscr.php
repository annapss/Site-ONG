...
<html lang="en">
  <head>
    ...
    <title>Inscrição Formulário</title>
    ...
    <div class="row justify-content-md-center">
      ...
      <div class="col-md-7">
        <div class="mb-3">
          ...
          <select class="form-select form-select mb-3" aria-label=".form-select-sm example" id="id_escolaridade">
    ...
    <div class="row justify-content-md-center">
      <div class="col-md-5">
        <div class="mb-3">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="Aulas Online" id="id_participacao_aulas">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="Aulas Presenciais" id="id_participacao_aulas">
            <label class="form-check-label" for="id_participacao_aulas">
              Aulas Presenciais
            </label>
          </div>
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="Produzir Reels-TikTok" id="id_participacao_aulas">
            <label class="form-check-label" for="id_participacao_aulas">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="Enviar Resumos" id="id_participacao_aulas">
            <label class="form-check-label" for="id_participacao_aulas">
              Enviar Resumos
            </label>
          </div>
      ...
      <div class="col-md-7">
        <div class="mb-3">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="Terça Feira-14:40 até 16:40" id="id_horario_presencial">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="Quinta Feira-16:00 até 16:50" id="id_horario_presencial">
            <label class="form-check-label" for="id_horario_presencial">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="Sexta Feira-11:10 até 12:00" id="id_horario_presencial">
            <label class="form-check-label" for="id_horario_presencial">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="Sexta Feira-de 15:50 até 16:40" id="id_horario_presencial">
            <label class="form-check-label" for="id_horario_presencial">
    ...
    <div class="row justify-content-md-center">
      <div class="col-md">
        <div class="mb-3">
          ...
          <textarea class="form-control" id="id_horarios_adicionais" rows="3"></textarea>
        </div>

        <div class="mb-3">
          <label for="id_materias_interesse" class="form-label">Qual(is) Matéria(s) você está interessado em ensinar? </label>
          <textarea class="form-control" id="id_materias_interesse" rows="3"></textarea>
        </div>
      </div>

      <div class="mb-3">
          <label for="id_outros" class="form-label">Outros</label>
          <textarea class="form-control" id="id_outros" rows="3"></textarea>
        </div>
      </div>
    </div>
